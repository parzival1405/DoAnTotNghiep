...
import { ShowAddBatchProductModal, ShowAddPrescriptionModal } from "../../../redux/actions/modal";
...
function PrescriptionSide({ item }) {
  ...
  const handleClickShowEditModal = (item) => {
    dispatch(ShowAddPrescriptionModal(GLOBALTYPES.ADD,item));
  };
